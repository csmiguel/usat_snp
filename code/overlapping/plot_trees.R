...
#bootstrap support
bt <- readRDS("data/intermediate/shared_boot_support.rds")
#trees
tr <- readRDS("data/intermediate/shared_bt_trees.rds")
#genotypes
gen <- readRDS("data/intermediate/shared_all_consolidated_filtered.rds")
#clumpak output: major cluster
qclumpak <- readRDS("data/intermediate/shared_clumpak_major.rds")
#pop ids
meta <- readRDS("data/intermediate/shared_table1.rds")
...
ggsave("data/final/shared_trees_structure.pdf", height = 16, width = 11)
