...
input_path1 <- "data/intermediate/shared_bt_trees.rds"
input_path2 <- "data/intermediate/shared_boot_support.rds"
...
saveRDS(bs_treemetrics, "data/intermediate/shared_bs_treemetrics.rds")
