...
*Number of markers and bootstrap support*.

*MAF and bootstrap support*.
...
*Marker type and bootstrap support*.
...
* Key result 2
The little bootstrap support we describe in phylogenetic trees from microtellite data is not surprising, given that often several tens of microsatellites or more are needed to recover the correct topology of trees (Nei et al. 1983; Takezaki and Nei 1996)
